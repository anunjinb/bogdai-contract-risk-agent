...
const SAMPLE_REPORT = {
  ...
  overall_assessment: {
    ...
    risk_score: 87,
    summary: "6 high-risk clause(s) identified. Key issues: Pricing – Vague Adjustment Language; Liability – Missing or Unlimited Cap; Liability – Absent Liability Cap Clause.",
    human_review_required: true,
  },
  risk_breakdown: { high: 6, medium: 0, low: 0, informational: 0 },
  flags: [
    {
      flag_id: "FLAG-001", clause: "7.1", title: "Pricing – Vague Adjustment Language",
      risk_category: "Financial", risk_level: "HIGH", risk_score: 85,
      ...
      reasoning_steps: [
        { step: 1, observation: "The contract contains vague pricing adjustment terms without a defined cap or review mechanism.", inference: "This lack of clarity creates uncertainty around potential cost fluctuations for the buyer." },
        { step: 2, observation: "The contract uses language such as 'prices may change based on market conditions' without qualification.", inference: "Such undefined language exposes the buyer to unpredictable and possibly significant price increases." },
        { step: 3, observation: "Policy indicates vague pricing adjustment terms without caps or review processes significantly increase financial dispute risk.", inference: "Therefore, the contract's terms materially increase the risk of financial disputes and unexpected costs for the buyer." },
      ],
      ...
      citations: [{ citation_id: "CIT-001", source_title: "Synthetic Pharma Contracting Guidelines", source_document: "synthetic_pharma_contracting_guidelines.md", section: "Pricing Terms", quoted_evidence: "Vague pricing adjustment language without a defined cap or structured review process materially increases financial dispute risk. Language such as \"prices may change based on market conditions\" without qualification is considered a high-risk contract term.", grounding_layer: "Foundry IQ", retrieval_confidence: 0.95 }],
      confidence: 0.89, needs_human_review: true,
    },
    {
      ...
      reasoning_steps: [
        { step: 1, observation: "The contract includes clauses imposing unlimited liability or explicitly removes any liability cap.", inference: "This creates a scenario where the party may face unlimited financial obligations without any defined cap." },
        { step: 2, observation: "Unlimited liability exposes the party to potentially extreme financial risks that could exceed reasonable or predictable limits.", inference: "Such financial exposure can threaten the party's solvency or cause significant financial harm." },
        { step: 3, observation: "Policy clearly states that contracts without liability caps are high-risk and require legal escalation before execution.", inference: "Therefore, executing this contract without escalating to legal counsel increases the organization's legal and financial risk." },
      ],
      ...
      citations: [{ citation_id: "CIT-002", source_title: "Synthetic Pharma Contracting Guidelines", source_document: "synthetic_pharma_contracting_guidelines.md", section: "Liability and Indemnification", quoted_evidence: "Contracts with no liability cap, or with language expressly removing any limitation, are considered high-risk and should be escalated to legal counsel before execution.", grounding_layer: "Foundry IQ", retrieval_confidence: 0.95 }],
      confidence: 0.89, needs_human_review: true,
    },
    {
      ...
      reasoning_steps: [
        { step: 1, observation: "The contract does not include any explicit liability cap or limitation clause.", inference: "This absence means there is no predefined maximum financial exposure for potential claims." },
        { step: 2, observation: "Policy states that contracts without liability caps or that remove limitations are considered high-risk.", inference: "Since the contract lacks such a provision, it automatically falls under a high-risk classification." },
        { step: 3, observation: "Undefined financial exposure can lead to unlimited liability in adverse scenarios.", inference: "This uncertainty necessitates escalation to legal counsel to mitigate unforeseen financial losses." },
      ],
    ...
    },
    {
      ...
      risk_category: "Operational", risk_level: "HIGH", risk_score: 85,
      ...
      reasoning_steps: [
        { step: 1, observation: "The delivery terms in the contract are conditioned on product availability without specifying an escalation timeline or substitution process.", inference: "This lack of clear procedures means that if the product becomes unavailable, there is no defined method to quickly address or mitigate the situation." },
        { step: 2, observation: "The policy explicitly states that contracts lacking escalation timelines or substitution processes create unacceptable supply continuity risks.", inference: "Because the contract aligns with these problematic conditions, it inherently exposes the supply chain to interruptions that could affect patient-facing procurement." },
        { step: 3, observation: "Patient-facing procurement programs rely on continuous and timely supply delivery to maintain care standards.", inference: "Any disruption caused by undefined escalation or substitution procedures can directly impact patient care delivery, making this an operational risk requiring high attention." },
      ],
      ...
      citations: [{ citation_id: "CIT-004", source_title: "Synthetic Healthcare Procurement Rules", source_document: "synthetic_healthcare_procurement_rules.md", section: "Supply Continuity and Escalation", quoted_evidence: "Contracts conditioned on availability without a defined escalation timeline or substitution process create unacceptable supply continuity risk for patient-facing procurement programs.", grounding_layer: "Foundry IQ", retrieval_confidence: 1.0 }],
      confidence: 0.91, needs_human_review: true,
    },
    {
      flag_id: "FLAG-005", clause: "4.2", title: "Audit Rights – Missing or Unclear",
      risk_category: "Compliance", risk_level: "HIGH", risk_score: 85,
      ...
      reasoning_steps: [
        { step: 1, observation: "The contract lacks defined audit rights, including scope, frequency, and escalation procedures.", inference: "Without clear audit rights, the organization cannot effectively monitor supplier compliance with regulatory and quality standards." },
        { step: 2, observation: "The supplier operates within a regulated pharmaceutical environment requiring strict adherence to compliance and quality controls.", inference: "Insufficient audit provisions increase the risk that non-compliant practices or quality issues may go undetected, potentially leading to regulatory violations." },
        { step: 3, observation: "Policy mandates that regulated supplier contracts must include well-defined audit rights to ensure transparency and enforceability.", inference: "The absence of such audit rights constitutes a compliance risk and may result in legal penalties, compromised product quality, and reputational damage." },
      ],
      ...
      citations: [{ citation_id: "CIT-005", source_title: "Synthetic Compliance Policy", source_document: "synthetic_compliance_policy.md", section: "Audit and Oversight", quoted_evidence: "Contracts with regulated suppliers should include defined audit rights with clear scope, frequency, and escalation procedures. Absence of audit rights in a pharmaceutical supply contract is a compliance risk indicator.", grounding_layer: "Foundry IQ", retrieval_confidence: 0.95 }],
      confidence: 0.89, needs_human_review: true,
    },
    {
      ...
      reasoning_steps: [
        { step: 1, observation: "The contract includes a termination for convenience clause allowing abrupt contract termination without cause.", inference: "This grants either party the ability to end the contract unexpectedly." },
        { step: 2, observation: "There is no requirement for sufficient notice or transition period upon termination.", inference: "Lack of notice can hinder orderly handover or replacement of services." },
        { step: 3, observation: "Policies indicate that contracts allowing immediate termination without cause or notice pose operational and patient care risks.", inference: "Abrupt termination risks disrupting supply continuity, affecting operations and patient care." },
      ],
      ...
      citations: [{ citation_id: "CIT-006", source_title: "Synthetic Pharma Contracting Guidelines", source_document: "synthetic_pharma_contracting_guidelines.md", section: "Termination Terms", quoted_evidence: "Contracts permitting immediate termination without cause or without an adequate notice period present operational and patient care risks.", grounding_layer: "Foundry IQ", retrieval_confidence: 0.95 }],
      confidence: 0.89, needs_human_review: true,
    },
  ],
  agent_trace: [
    ...
    { agent_name: "Grounding Agent", role: "Retrieved supporting evidence from approved synthetic knowledge sources.", tool_used: "Foundry IQ", output: "Retrieved citations for 6 risk flags from 3 synthetic knowledge source(s)." },
    ...
    { agent_name: "Verifier Agent", role: "Checked for unsupported claims, missing citations, and unsafe recommendations.", tool_used: null, output: "Marked 6 high-risk flags as requiring human legal/compliance review." },
